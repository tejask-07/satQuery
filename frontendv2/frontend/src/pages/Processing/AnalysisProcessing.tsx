 ...
 */
function getBounds(aoi: AOIMetadata) {
...
function getCenter(aoi: AOIMetadata): [number, number] {
  const coordinates = aoi.geometry.coordinates;
...
function getSatelliteImageUrl(aoi: AOIMetadata) {
          ...
          <section className="investigation-section">
            <div className="investigation-details">
              ...
              <div className="investigation-row">
                ...
                <div className="investigation-value">
                  <strong>
                    {aoi.area ? `${aoi.area} km²` : "SELECTED REGION"}
                  </strong>
                </div>
              </div>
